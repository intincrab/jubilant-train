...
WASM_CFLAGS = -s WASM=1 -s EXPORTED_FUNCTIONS='["_compile", "_tokenize", "_free_result", "_free_tokens", "_malloc", "_free", "_main"]' -s EXPORTED_RUNTIME_METHODS='["ccall", "cwrap", "UTF8ToString"]' -s ALLOW_MEMORY_GROWTH=1
